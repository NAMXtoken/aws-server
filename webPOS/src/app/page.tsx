...
export default async function HomePage() {
    ...
    return (
        <main className="relative min-h-svh overflow-hidden bg-slate-950 text-white">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.2)_0,rgba(15,23,42,0)_55%),radial-gradient(circle_at_bottom,rgba(14,165,233,0.25)_0,rgba(2,6,23,0)_60%)]" />
